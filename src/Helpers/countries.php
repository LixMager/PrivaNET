<?php
/**
 * Lista de países del mundo ordenados alfabéticamente en español.
 * Para usar: include este archivo y llama a getCountries().
 * Retorna un array asociativo [ 'valor_en_db' => 'Nombre visible' ]
 */
